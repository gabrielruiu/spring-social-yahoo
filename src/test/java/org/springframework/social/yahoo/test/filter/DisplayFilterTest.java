...
/**
 * Test class that verifies if the {@link DisplayFilter} implementation of {@link RequestCustomizer} properly builds
 * requests for filtering the fields in each Contact of the Contacts resource,
